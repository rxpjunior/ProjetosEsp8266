...
#define MQTT_ID "KaJoRoSB2" //Substituir MQTT-ID pela identificação do cliente no MQTT no Broker
...
String newHostname = "KaJoRoSB"; //Substituir YYYYYY pelo nome do grupo
